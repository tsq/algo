...
//    that gets asssigned to the data property and initialize an
//    empty array for storing children. The node class should have
//    methods 'add' and 'remove'
// 2) Create a tree class. The tree constructor should initialize a
//    'root' property to null.
// 3) Implement 'traverseBF' and 'traverseDF'
//    on the tree class. Each method should accept
